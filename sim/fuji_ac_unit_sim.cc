...
namespace fuji_iot
{
    namespace sim
    {
        ...
        FujiAcUnitSim::FujiAcUnitSim()
        {
            ...
            status_ = std::unique_ptr<FujiStatusRegister>(new FujiStatusRegister(status_register_.data() + 3));
        }
        ...
        void FujiAcUnitSim::Update()
        {
            status_->SetUpdateMagic(4);
        }

        bool FujiAcUnitSim::Enabled() const
        {
        ...
        uint8_t FujiAcUnitSim::Temperature() const
        {
        ...
        mode_t FujiAcUnitSim::Mode() const
        {
            return status_->Mode();
        }
        ...
        bool FujiAcUnitSim::Economy() const
        {
            return status_->Economy();
        }
        ...
        bool FujiAcUnitSim::Swing() const
        {
            return status_->Swing();
        }
        ...
        bool FujiAcUnitSim::SwingStep() const
        {
            return status_->SwingStep();
        }
