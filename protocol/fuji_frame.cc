...
namespace fuji_iot
{
    ...
    FujiMasterFrame::FujiMasterFrame(std::array<uint8_t, 8> data)
    {
        data_ = data;
    }

    bool FujiMasterFrame::UnknownBit() const
    {
        return (data_[1] & 0b10000000) > 0;
    }
    ...
    std::array<uint8_t, 8> FujiMasterFrame::FullFrame() const
    {
        return data_;
    }
    ...
    FujiControllerFrame::FujiControllerFrame() : FujiControllerFrame({0, 129, 0, 0, 0, 0, 0, 0})
    {
    ...
    std::array<uint8_t, 8> FujiControllerFrame::FullFrame() const
    {
        return data_;
    }
    ...
    std::array<uint8_t, 8> FujiControllerFrame::BuildFrame()
    {
        return data_;
    }
